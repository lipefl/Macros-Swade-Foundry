/// v1.4
/// TODO => Remake with actions
/* 
weapon.data.actions.skill   
weapon.data.actions.skillMod
weapon.data.actions.dmgMod

and power

weapon.data.actions.additional (info - other actions) 
*/
...
let activeCombatId=game.combats.active.id;
let activeCombat=game.combats.find(el=>el.id===activeCombatId);
